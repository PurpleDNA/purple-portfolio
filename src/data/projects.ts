...
export const projects: ProjectDetail[] = [
  ...
  },
  {
    ...
    link: "https://top-business-platform-v2.pxxl.run/",
  },
  {
    id: "glory-house-loans",
    name: "Glory House - ",
    organization: "Cooperative Society",
    skill: "Fullstack",
    year: "2026",
    image: "/assets/projects/project-glory-house.png",
    title: "Glory House - Loan Management",
    description:
      "An internal loan management platform for Glory House Multipurpose Cooperative Society Limited. It handles the full loan lifecycle, from member applications and approvals to interest calculation and repayment tracking, with a full audit trail of who did what and dashboards that show the society's lending health at a glance.",
    industry: "FinTech, Cooperative Finance",
    technology: ["Next.js", "Node.js", "PostgreSQL"],
    role: "Lead Fullstack Developer",
    classifications: "Internal Tool",
    challenges: [
      "Paper-based loan applications and approvals",
      "Error-prone manual interest and repayment calculations",
      "No accountability for changes made to member records",
    ],
    solutions: [
      "Digital loan application and approval workflow",
      "Automated interest computation and repayment schedules",
      "Activity log recording every action and the staff member behind it",
    ],
    images: [
      "/assets/glory-house/gh_dashboard.png",
      "/assets/glory-house/gh_dashboard2.jpg",
      "/assets/glory-house/gh_members-redacted_dot_app.png",
      "/assets/glory-house/gh_loan-application-redacted_dot_app.png",
      "/assets/glory-house/gh_loan-management-redacted_dot_app.png",
      "/assets/glory-house/gh_loan-disbursement-redacted_dot_app.png",
      "/assets/glory-house/gh_interest-redacted_dot_app.png",
      "/assets/glory-house/gh_activity-log.png",
    ],
    link: "",
  },
  {
